...
using System.Linq;
using PhotoSharing.Web.Controllers;
using PhotoSharing.Test;
...
namespace PhotoSharingTests
{
    ...
    public class PhotoControllerTests
    {
        ...
        public void Test_DisplayByTitle_Return_Photo()
        {
            ...
            var context = new FakePhotoSharingContext();
            context.Photos = new[] {
                new Photo{ Id = 1, Title="Photo1" },
                new Photo{ Id = 2, Title="Photo2" },
                new Photo{ Id = 3, Title="Photo3" },
                new Photo{ Id = 4, Title="Photo4" }
            }.AsQueryable();

            var controller = new PhotoController(context);
            var result = controller.DisplayByTitle("Photo2") as ViewResult;
            var resultPhoto = (Photo)result.Model;
            Assert.AreEqual(2, resultPhoto.Id);
        }
