...
namespace PhotoSharingTests
{
    ...
    public class RoutingTests
    {
        ...
        /// <summary>
        /// Tests the default route controller only.
        /// </summary>
        [TestMethod]
        public void Test_Default_Route_ControllerOnly()
        {
            ...
            PhotoSharing.Web.RouteConfig.RegisterRoutes(routes);
        ...
        /// <summary>
        /// Tests the photo route with photo identifier.
        /// </summary>
        [TestMethod]
        ...
        /// <summary>
        /// Tests the photo title route with title.
        /// </summary>
        [TestMethod]
